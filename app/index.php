    ...
    <div class="row row-cols-1 row-cols-md-1">
        <div class="col mb-4">
            ...
            <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                Total de Casos Reportados: 196515 Casos
            </div>
        ...
        <div class="col mb-4">
            <div class="card border-info">
            <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                Nuevos Casos vs Diferencial con día anterior(*) - 4757 Nuevos Casos Reportados
            </div>
        ...
        <div class="col mb-4">
            <div class="card border-info">
                <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                    Casos Activos vs Diferencial con día anterior - 104831 Casos Activos
                </div>
        ...
        <div class="col mb-4">
            <div class="card border-info">
                <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                    Casos Nuevos vs Pruebas Realizadas - 18953 Nuevas Pruebas Realizadas
                </div>
        ...
        <div class="col mb-4">
            <div class="card border-info">
                <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                    Casos Nuevos vs Recuperados Nuevos - 3488 Recuperados Nuevos
                </div>
        ...
        <div class="col mb-4">
            <div class="card border-info">
                <div class="card-header text-center text-white font-weight-bold bg-info mb-3">
                    Total de Pruebas y Nuevas Pruebas Realizadas - 1191956 Total de Pruebas Realizadas
                </div>
